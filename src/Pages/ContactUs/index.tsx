...
const ContactUs = ({setSelectedPage}: Props) => {
  const inputStyles = `mb-5 w-full rounded-lg bg-primary-500 px-5 py-3 placeholder-white focus:outline-none`;
        ...
        <div className="mt-10 justify-between md:flex">
            ...
            >
              <form
                ...
                onSubmit={onSubmit}
                method="POST"
                action="https://formsubmit.co/marcoskommling@gmail.com"
              >
                <input
